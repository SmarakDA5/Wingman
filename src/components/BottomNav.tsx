  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto flex items-center justify-around px-4 py-2">
        <NavItem to="/app/feeds" icon={<Home size={20} />} label="Feeds" />
        <NavItem to="/app/info" icon={<User size={20} />} label="Profile" />
        <NavItem to="/app/likes" icon={<Heart size={20} />} label="Likes" />
